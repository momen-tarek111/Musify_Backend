...
import in.MomenTarek.musifyapi.security.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public UrlBasedCorsConfigurationSource corsConfigurationSource(){
        ...
        config.setAllowedOrigins(List.of("http://localhost:5173","http://localhost:5174","https://musify-admin-front-end.vercel.app","https://musify-front-end.vercel.app"));
